Feature: Create a new post
  ...
  Scenario: Login as admin in BO and create a new Post. (Test Variant: Desktop, Browser Chrome)
...
#  Scenario: Login as admin in BO and create a new Post.  (Test Variant: Desktop, Browser Firefox)
